...
print(f"R2 (treinamento) => {regressor_random_forest_casas.score(X_casas_treinamento, y_casas_treinamento)}")
print(f"R2 (teste) => {regressor_random_forest_casas.score(X_casas_teste, y_casas_teste)}")

previsoes = regressor_random_forest_casas.predict(X_casas_treinamento)
